...
// Vendored verbatim from React Bits (reactbits.dev) — WebThreads, JS + CSS
// variant. Only change from upstream: the "use client" directive above, so it
// runs in the Next.js App Router. Depends on `ogl` (already a project dep via
// GradientWaves).
