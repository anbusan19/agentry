...
// Vendored verbatim from React Bits (reactbits.dev) — FloatingLines, JS + CSS
// variant. Only change from upstream: the "use client" directive above, so
// it runs in the Next.js App Router. Depends on `three` (already a project
// dep via KnowledgeGraphOrb/ArchitectureDiagram).
