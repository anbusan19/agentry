...
// Vendored verbatim from React Bits (reactbits.dev) — LightRays, JS + CSS
// variant. Only change from upstream: the "use client" directive above, for
// the Next.js App Router. Depends on `ogl` (already a project dep).
