...
// Open-source component from React Bits (reactbits.dev), JavaScript + CSS
// variant. Verbatim from the published source; only "use client" is added for
// the Next.js App Router. Depends on `ogl`.
